...
import { useLogin } from "@/app/features/useLogin";
...
const Page = () => {
  ...
  const {handleSubmit, register, reset, formState:{errors}}=useForm({resolver: zodResolver (zodScheme)})
  const postData = useLogin((set:any) => set.postLogin);
  ...
  return (
    <>
      <div className="container mx-auto flex justify-between">
        <div  className="flex max-w-divinput flex-col gap-7 w-full  mt-8" style={{marginLeft:"100px"}}>
